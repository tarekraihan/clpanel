...
(function () {
    ...
    function x(a, b, c, d) {
        ...
        if (this._options.stripLines &&
            0 < this._options.stripLines.length)for (this.stripLines = [], b = 0; b < this._options.stripLines.length; b++)this.stripLines.push(new la(this.chart, this._options.stripLines[b], a.theme, ++this.chart._eventManager.lastObjectId, this));
    ...
    var t = !!document.createElement("canvas").getContext, ma = {
        ...
        a = (b[1] + "").split("");
        g && "0" === g[0] && g.shift();
        for (t = r = k = m = p = 0; 0 < l.length;)if (b = l.pop(), "#" === b || "0" === b)if (p++, p === n) {
            var u = g, g = [];
    ...
    F.prototype.removeEventListener = function (a, b) {
        if (a && b && this._eventListeners[a])for (var c =
            this._eventListeners[a], d = 0; d < c.length; d++)if (c[d].eventHandler === b) {
            c[d].splice(d, 1);
            break
        }
    };
    ...
    w.prototype._initialize = function () {
        ...
        this.data = [];
        for (var a = 0, b = 0; b < this._options.data.length; b++)if (a++, !this._options.data[b].type ||
    ...
    w.prototype.render = function (a) {
        ...
        if (this._options.subtitles)for (a = 0; a < this._options.subtitles.length; a++) {
            this.subtitles = [];
        ...
        if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement)x.setLayoutAndRender(this.axisX, this.axisY, this.axisY2, this.plotInfo.axisPlacement, this.layoutManager.getFreeSpace()); else if ("none" === this.plotInfo.axisPlacement)this.preparePlotArea(); else return;
        a = 0;
    ...
    w.prototype._processMultiseriesPlotUnit =
        function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement)var n = this.sessionVariables.axisX.internalMinimum ? this.sessionVariables.axisX.internalMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum : -Infinity, m = this.sessionVariables.axisX.internalMaximum ?
                ...
                for (p = 0; p < k.dataPoints.length; p++) {
                    ...
                    if (!(d < n) || l) {
                        ...
                        if (d > m && !h)h = !0; else if (d > m && h)continue;
    ...
    w.prototype._processStackedPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = [], k = [], p = 0; p < a.dataSeriesIndexes.length; p++) {
                ...
                if ("normal" === l.axisPlacement || "xySwapped" === l.axisPlacement)var q = this.sessionVariables.axisX.internalMinimum ? this.sessionVariables.axisX.internalMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum : -Infinity, r = this.sessionVariables.axisX.internalMaximum ? this.sessionVariables.axisX.internalMaximum :
                ...
                for (h = 0; h < l.dataPoints.length; h++) {
                    ...
                    if (!(d < q) || n) {
                        ...
                        if (d > r && !m)m = !0; else if (d > r && m)continue;
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f, g, k = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
            ...
            for (h = 0; h < l.dataPoints.length; h++) {
                ...
                if (!(d < q) || n) {
                    ...
                    if (d >
                        r && !m)m = !0; else if (d > r && m)continue;
                    l.dataPoints[h].label && (a.axisX.labels[d] = l.dataPoints[h].label);
                    d < c.viewPortMin && (c.viewPortMin = d);
                    d > c.viewPortMax && (c.viewPortMax = d);
    ...
    w.prototype.getDataPointAtXY = function (a, b, c) {
        ...
        a = null;
        b = !1;
        for (c = 0; c < d.length; c++)if ("line" === d[c].dataSeries.type || "stepLine" === d[c].dataSeries.type || "area" === d[c].dataSeries.type || "stepArea" === d[c].dataSeries.type)if (e = N("markerSize", d[c].dataPoint, d[c].dataSeries) || 8, d[c].distance <= e / 2) {
            b = !0;
            break
        }
    ...
    w.prototype.renderIndexLabels = function (a) {
        ...
        for (var b = this.plotArea, c = 0, d = 0, e = 0, f = 0, g = 0, k = d = g = e = 0, p = 0; p < this._indexLabels.length; p++) {
            ...
            var g = N("indexLabelFontWeight", l.dataPoint, l.dataSeries), d = N("indexLabelBackgroundColor", l.dataPoint, l.dataSeries), e = N("indexLabelMaxWidth", l.dataPoint, l.dataSeries), q = N("indexLabelWrap", l.dataPoint, l.dataSeries), r = {
                    percent: null,
                    total: null
                },
                s = null;
            ...
            if (null !== t && "" !== t) {
                ...
                if ("normal" === this.plotInfo.axisPlacement) {
                    if (0 <= f.indexOf("line") || 0 <= f.indexOf("area"))c = "auto", g = 4; else if (0 <= f.indexOf("stacked"))"auto" === c && (c = "inside"); else if ("bubble" === f || "scatter" === f)c = "inside";
                    h = l.point.x - d / 2;
    ...
    w.prototype.renderLine = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                b.beginPath();
                if (0 < k.length) {
                    for (var q = !1, h = 0; h < k.length; h++)if (n = k[h].x.getTime ? k[h].x.getTime() : k[h].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))if ("number" !== typeof k[h].y)0 < h && (b.stroke(), t && c.stroke()), q = !0; else {
    ...
    w.prototype.renderStepLine = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                b.beginPath();
                if (0 < k.length) {
                    for (var q = !1, h = 0; h < k.length; h++)if (n = k[h].getTime ? k[h].x.getTime() : k[h].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))if ("number" !== typeof k[h].y)0 < h && (b.stroke(), t && c.stroke()), q = !0; else {
                        var r = m;
                        n = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (n - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                        m = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (k[h].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
    ...
    w.prototype.renderSpline = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var e = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                var h = 0, n, m, q = [];
                c.beginPath();
                if (0 < p.length)for (h = 0; h < p.length; h++)if (n = p[h].getTime ? p[h].x.getTime() : p[h].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))if ("number" !== typeof p[h].y)0 < h && (b(q), q = []); else {
                    n = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (n - a.axisX.conversionParameters.minimum) + 0.5 << 0;
    ...
    w.prototype.renderColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                if (0 < m.length)for (var q = 5 < h && n.bevelEnabled ? !0 : !1, e = 0; e < m.length; e++)if (m[e].getTime ? k = m[e].x.getTime() :
    ...
    w.prototype.renderStackedColumn100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                var n = a.dataSeriesIndexes[l], m = this.data[n], q = m.dataPoints;
                if (0 < q.length)for (var r = 5 < h && m.bevelEnabled ? !0 : !1, g = 0; g < q.length; g++)if (c = q[g].x.getTime ? q[g].x.getTime() : q[g].x, !(c <
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < h.length) {
                    ...
                    for (var H = !0; m < h.length; m++)if (s = h[m].x.getTime ? h[m].x.getTime() : h[m].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax))if ("number" !== typeof h[m].y)b(), H = !0; else {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < h.length) {
                    ...
                    c.strokeStyle = color;
                    c.lineWidth = l.lineThickness;
                    for (c.setLineDash && c.setLineDash(M(l.lineDashType, l.lineThickness)); n < h.length; n++)if (m = h[n].x.getTime ? h[n].x.getTime() : h[n].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax))if ("number" !== typeof h[n].y)0 < n && (b(), u = []); else {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < h.length) {
                    ...
                    c.strokeStyle = H;
                    c.lineWidth = l.lineThickness;
                    for (c.setLineDash && c.setLineDash(M(l.lineDashType, l.lineThickness)); m < h.length; m++)if (s = h[m].x.getTime ? h[m].x.getTime() : h[m].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax)) {
                        var w = r;
                    ...
                    if (0 < g.length) {
                        ...
                        for (k = 0; k < g.length; k++) {
                            ...
                            if (!(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof v.y) {
                                ...
                                u.push({x: p, y: n - C});
                                f[h] = n - l;
                                if (z)b.beginPath(), b.moveTo(p, l), t && (m.beginPath(), m.moveTo(p, l)), z = !1; else if (b.lineTo(p, l), t && m.lineTo(p, l), 0 == k % 250) {
                ...
                if (0 < g.length) {
                    ...
                    for (k = 0; k < g.length; k++) {
                        ...
                        if (!(h < a.axisX.dataInfo.viewPortMin ||
                            ...
                            C.push({x: p, y: n - D});
                            f[h] = n - l;
                            if (v)b.beginPath(), b.moveTo(p, l), t && (r.beginPath(), r.moveTo(p, l)), v = !1; else if (b.lineTo(p,
    ...
    w.prototype.renderBubble = function (a) {
        ...
        if (!(0 >= c)) {
            ...
            b.clip();
            t && (this._eventManager.ghostCtx.rect(d.x1, d.y1, d.width, d.height), this._eventManager.ghostCtx.clip());
            for (var p = -Infinity, l = Infinity, h = 0; h < a.dataSeriesIndexes.length; h++)for (var n = a.dataSeriesIndexes[h],
            ...
            for (var s = 25 * Math.PI, d = Math.max(Math.pow(0.25 * Math.min(d.height, d.width) / 2, 2) * Math.PI, s), h = 0; h < a.dataSeriesIndexes.length; h++)if (n = a.dataSeriesIndexes[h], m = this.data[n], q = m.dataPoints, 1 == q.length && (c = k), 1 > c ? c = 1 : c > k && (c = k), 0 < q.length)for (b.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)if (f =
        ...
        if (!(0 >= c)) {
            ...
            for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                ...
                if (0 < n.length) {
                    ...
                    for (var m = 0, q = 0, e = 0; e < n.length; e++)if (f = n[e].getTime ? f = n[e].x.getTime() : f = n[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y) {
                        f = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (f - a.axisX.conversionParameters.minimum) + 0.5 << 0;
    ...
    w.prototype.renderCandlestick = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                if (0 < s.length)for (var z = 5 < n && r.bevelEnabled ? !0 : !1, e = 0; e < s.length; e++)if (s[e].getTime ? h = s[e].x.getTime() : h = s[e].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && null !== s[e].y && s[e].y.length && "number" === typeof s[e].y[0] && "number" === typeof s[e].y[1] && "number" === typeof s[e].y[2] && "number" === typeof s[e].y[3]) {
                    ...
                    (s[e].indexLabel || r.indexLabel || s[e].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                        ...
                        point: {x: u + (v - u) / 2, y: k},
                        direction: 1,
                        bounds: {x1: u, y1: Math.min(k, p), x2: v, y2: Math.max(k, p)},
                        color: d
                    })
                }
            }
    ...
    w.prototype.renderRangeColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                var l = a.dataSeriesIndexes[p], h = this.data[l], n = h.dataPoints;
                if (0 < n.length)for (var m = 5 < k && h.bevelEnabled ? !0 : !1, e = 0; e < n.length; e++)if (n[e].getTime ? g = n[e].x.getTime() : g = n[e].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && null !== n[e].y && n[e].y.length && "number" === typeof n[e].y[0] && "number" === typeof n[e].y[1]) {
                    c =
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                if (0 < m.length) {
                    ...
                    b.strokeStyle = "#4572A7 ";
                    for (e = 0; e < m.length; e++)if (m[e].getTime ? k = m[e].x.getTime() : k = m[e].x, !(k < a.axisX.dataInfo.viewPortMin ||
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < l.length) {
                    ...
                    for (var v = !0; n < l.length; n++)if (s = l[n].x.getTime ? l[n].x.getTime() : l[n].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax))if (null !== l[n].y && l[n].y.length && "number" === typeof l[n].y[0] && "number" === typeof l[n].y[1]) {
                        ...
                        h || v ? (c.beginPath(), c.moveTo(m, q), z = {x: m, y: q}, g = [], g.push({
                            x: m,
                            y: r
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < p.length) {
                    ...
                    c.strokeStyle = color;
                    c.lineWidth = k.lineThickness;
                    for (c.setLineDash && c.setLineDash(M(k.lineDashType, k.lineThickness)); l < p.length; l++)if (h = p[l].x.getTime ? p[l].x.getTime() : p[l].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax))if (null !== p[l].y && p[l].y.length && "number" === typeof p[l].y[0] && "number" === typeof p[l].y[1]) {
    ...
    w.prototype.renderPie =
        function (a) {
            function b() {
                if (h && n) {
                    ...
                    for (x = 0; x < n.length; x++) {
                        var e = n[x], f = h.dataPointIds[x], g = {
                            id: f,
                            objectType: "dataPoint",
                            dataPointIndex: x,
                            dataSeriesIndex: 0
            ...
            function f(a) {
                for (var b = null, c = 1; c < n.length; c++)if (b = (a + c + s.length) % s.length, s[b].hemisphere !== s[a].hemisphere) {
                    b = null;
                    break
            ...
            function g(a, b) {
                ...
                if (0 <= a && a < n.length) {
                    ...
                    d = null;
                    for (h = 1; h < n.length; h++)if (d = (a - h + s.length) % s.length, s[d].hemisphere !== s[a].hemisphere) {
                        d =
                            null;
                        break
                    } else if (s[d].indexLabelText && s[d].hemisphere === s[a].hemisphere && d !== a && (0 > e(s[d], s[a]) || ("right" === s[a].hemisphere ? s[d].indexLabelTextBlock.y <= s[a].indexLabelTextBlock.y : s[d].indexLabelTextBlock.y >= s[a].indexLabelTextBlock.y)))break; else d = null;
                    q = d;
                    m = f(a);
                    h = d = 0;
            ...
            function k() {
                ...
                for (var b = 0, c = a = 0, a = 0; 10 > a && (1 > a || 0 < c); a++) {
                    ...
                    } else for (b = 0; b < n.length; b++)k = s[b], B = "pie" === h.type ? 0.7 * D : 0.8 * D, x = y.x + B * Math.cos(k.midAngle), A = y.y + B * Math.sin(k.midAngle), k.indexLabelTextBlock.x = x, k.indexLabelTextBlock.y = A;
                    ...
                    v = k = -1;
                    for (A = E = 0; A < n.length; A++)if (p = s[A], p.indexLabelText) {
                        var F = f(A);
        ...
        for (var l = 0; l < this.dataSeries.length; l++) {
            ...
            if ("pie" !== h.type && "doughnut" !== h.type && "funnel" !== h.type) {
                var n = h.legendMarkerType ? h.legendMarkerType :
                    "line" !== h.type && "stepLine" !== h.type && "spline" !== h.type && "scatter" !== h.type && "bubble" !== h.type || !h.markerType ? R.getDefaultLegendMarker(h.type) : h.markerType, m = h.legendText ? h.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                    chart: this.chart,
                    legend: this._options,
                    dataSeries: h,
                    dataPoint: null
                }) : h.name, q = h.legendMarkerColor ? h.legendMarkerColor : h.markerColor ? h.markerColor : h._colorSet[0], r = h.markerSize || "line" !== h.type && "stepLine" !== h.type && "spline" !== h.type ? 0.6 * this.lineHeight : 0, s = h.legendMarkerBorderColor ?
                    h.legendMarkerBorderColor : h.markerBorderColor, t = h.legendMarkerBorderThickness ? h.legendMarkerBorderThickness : h.markerBorderThickness ? Math.max(1, Math.round(0.2 * r)) : 0, m = this.chart.replaceKeywordsWithValue(m, h.dataPoints[0], h, l), n = {
                    markerType: n,
                    markerColor: q,
                    text: m,
                    textBlock: null,
                ...
                var v = h.dataPoints[u], n = v.legendMarkerType ?
                    v.legendMarkerType : h.legendMarkerType ? h.legendMarkerType : R.getDefaultLegendMarker(h.type), m = v.legendText ? v.legendText : h.legendText ? h.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                    chart: this.chart,
                    legend: this._options,
                    dataSeries: h,
                    dataPoint: v
                }) : v.name ? v.name : "DataPoint: " + (u + 1), q = v.legendMarkerColor ? v.legendMarkerColor : h.legendMarkerColor ? h.legendMarkerColor : v.color ? v.color : h.color ? h.color : h._colorSet[u % h._colorSet.length], r = 0.6 * this.lineHeight, s = v.legendMarkerBorderColor ? v.legendMarkerBorderColor :
                    h.legendMarkerBorderColor ? h.legendMarkerBorderColor : v.markerBorderColor ? v.markerBorderColor : h.markerBorderColor, t = v.legendMarkerBorderThickness ? v.legendMarkerBorderThickness : h.legendMarkerBorderThickness ? h.legendMarkerBorderThickness : v.markerBorderThickness || h.markerBorderThickness ? Math.max(1, Math.round(0.2 * r)) : 0, m = this.chart.replaceKeywordsWithValue(m, v, h, u), n = {
                    markerType: n,
                    markerColor: q,
                    text: m,
                    textBlock: null,
    ...
    R.prototype.getDataPointAtX = function (a, b) {
        ...
        var c = {
            ...
            distance: Infinity,
            index: NaN
        }, d = null, e = 0, f = 0, g = 1, k = Infinity, p = 0, l = 0, h = 0;
    ...
    x.prototype.renderStripLinesOfThicknessType = function (a) {
        if (this.stripLines && 0 <
            this.stripLines.length && a)for (var b = 0, b = 0; b < this.stripLines.length; b++) {
    ...
    w.prototype.getPercentAndTotal = function (a, b) {
        ...
        if (0 <= a.type.indexOf("stacked"))d = 0, c = b.x.getTime ? b.x.getTime() : b.x, c in a.plotUnit.yTotals && (d = a.plotUnit.yTotals[c], e = isNaN(b.y) ? 0 : 0 === d ? 0 : 100 * (b.y / d)); else if ("pie" === a.type || "doughnut" === a.type) {
    ...
    ba.prototype.mouseEventHandler = function (a) {
        if ("mousemove" === a.type || "click" === a.type) {
            ...
            for (c = 0; c < this.mouseoveredObjectMaps.length; c++) {
                f = !0;
                for (d = 0; d < b.length; d++)if (b[d].id ===
